...
```bash
git remote add encore encore://itau-token-system-d84i
```
...
Monitor your deployment progress in the [Encore Cloud dashboard](https://app.encore.dev/itau-token-system-d84i/deploys).
...
2. Navigate to Encore Cloud [GitHub Integration settings](https://app.encore.cloud/itau-token-system-d84i/settings/integrations/github)
